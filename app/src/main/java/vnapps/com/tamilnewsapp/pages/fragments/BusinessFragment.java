 ...
 */
public class BusinessFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, ServiceListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bussines, container, false);
        initViews(view);
        getNewsFeeds();
        return view;
    }
    ...
    private void getNewsFeeds() {
        ...
        apiService.getBussinessNews().enqueue(new RequestCallback(this));
    }
