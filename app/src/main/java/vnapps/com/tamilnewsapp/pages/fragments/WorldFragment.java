 ...
 */
public class WorldFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, ServiceListener {
    ...
    private void initViews(View view) {
        rvWorld = view.findViewById(R.id.rv_world);
    ...
    private void getNewsFeeds() {
        ...
        apiService.getWorldNews().enqueue(new RequestCallback(this));
    }
    ...
    private void setupAdapter(NewsFeeds newsFeeds) {
        ...
        rvWorld.setLayoutManager(new LinearLayoutManager(context));
        rvWorld.setAdapter(newsAdapter);
    }
    ...
    public void onSuccess(JsonResponse jsonResp, String data) {
        ...
        rvWorld.setVisibility(View.VISIBLE);
    ...
    public void onFailure(JsonResponse jsonResp, String data) {
        ...
        if (data.equals(getResources().getString(R.string.network_failure))) {
            rvWorld.setVisibility(View.GONE);
